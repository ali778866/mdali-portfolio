        ...
        <>
            <div className='min-h-screen flex items-center justify-center relative'>
                <div className='text-center z-10 px-4'>
                    <h1 className='text-5xl md:text-7xl font-mono font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right'>
                    ...
                    <div className='flex justify-center space-x-4'>
                        ...
                        <a href="#contact" className='border border-blue-500 text-blue-400 py-3 px-6 rounded font-medium transition-all
                        duration-200 hover:-translate-y-0.5 hover: shadow-[0_0_15px_rgba(59, 130, 246, 0.2)] hover: bg-blue-500/10'>Contact Me</a>
                        <a href={resume} target="_blank" rel="noopener noreferrer" className='border border-blue-500 text-blue-400 py-3 px-6 rounded font-medium transition-all
