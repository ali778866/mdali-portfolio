            ...
            <div id="home" className='min-h-screen flex items-center justify-center relative'>
                <div className='text-center z-10 px-4'>
                    ...
                    <div className='flex flex-wrap justify-center space-x-4 gap-y-3'>
                        ...
                        <a href={resume} target="_blank" rel="noopener noreferrer" className='border font-mono border-blue-500 text-blue-400 py-3 px-6 rounded font-medium transition-all
